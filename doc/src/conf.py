# -*- coding: utf-8 -*-
#
# mahler.dashboard.hpo documentation build configuration file.
#
...
import mahler.dashboard.hpo as dashboard_plugin
...
project = u'mahler.dashboard.hpo'
...
latex_documents = [
  (master_doc, 'mahler.dashboard.hpo.tex',
   u'Mahler dashboard hpo Documentation',
...
texinfo_documents = [
  (master_doc, 'hpo',
   u'Mahler dashboard hpo Documentation',
   author, 'hpo', dashboard_plugin.__descr__,
   'Miscellaneous'),
]
